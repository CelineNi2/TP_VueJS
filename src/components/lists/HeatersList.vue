  ...
  <div class="heaters-list pt-3">
    ...
    <template v-if="!isHeaterCreationVisible">
      <div class="d-flex mb-2">
        <button type="button" class="btn btn-primary" @click="toggleHeaterCreation">Create new heater</button>
      </div>

      <heaters-list-item v-for="heater in heaters"
                         :heater="heater"
                         :key="heater.id"
    ...
    <template v-if="isHeaterCreationVisible">
      <div class="d-flex mb-2">
        <button type="button" class="btn btn-primary me-2" @click="createHeater">Create</button>
        <button type="button" class="btn btn-danger" @click="toggleHeaterCreation">Cancel</button>
      </div>
      ...
      <form>
        <input type="text" class="form-control mb-3" placeholder="Heater name" v-model="name">
