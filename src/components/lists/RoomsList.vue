  ...
  <div class="rooms-list pt-3">
    ...
    <template v-if="!isRoomCreationVisible">
      <div class="d-flex mb-2">
        <button type="button" class="btn btn-primary" @click="toggleRoomCreation">Create new room</button>
      </div>

      <rooms-list-item v-for="room in rooms"
                       :room="room"
                       :key="room.id"
    ...
    <template v-if="isRoomCreationVisible">
      <div class="d-flex mb-2">
        <button type="button" class="btn btn-primary me-2" @click="createRoom">Create</button>
        <button type="button" class="btn btn-danger" @click="toggleRoomCreation">Cancel</button>
      </div>
      ...
      <form>
        ...
        <input type="text" class="form-control mb-3" placeholder="Current temperature" v-model="currentTemp">
        <input type="text" class="form-control mb-3" placeholder="Target temperature" v-model="targetTemp">
        <input type="text" class="form-control mb-3" placeholder="Floor" v-model="floor">
