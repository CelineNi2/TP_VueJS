  ...
  <div class="buildings-list pt-3">
    ...
    <template v-if="!isBuildingCreationVisible">
      <div class="d-flex mb-2">
        <button type="button" class="btn btn-primary" @click="toggleBuildingCreation">Create new building</button>
      </div>

      <buildings-list-item v-for="building in buildings"
                           :building="building"
                           :key="building.id"
    ...
    <template v-if="isBuildingCreationVisible">
      <div class="d-flex mb-2">
        <button type="button" class="btn btn-primary me-2" @click="createBuilding">Create</button>
        <button type="button" class="btn btn-danger" @click="toggleBuildingCreation">Cancel</button>
      </div>
      ...
      <form>
        <input type="text" class="form-control mb-3" placeholder="Building name" v-model="name">
        <input type="text" class="form-control mb-3" placeholder="Outside temperature" v-model="outsideTemp">
      </form>
    </template>
